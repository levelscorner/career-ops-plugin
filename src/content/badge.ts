// Floating "Evaluate with career-ops" badge injected into job pages.
...
export function mountBadge(
  ...
  button.innerHTML =
    '<span class="dot"></span><span class="label">Evaluate with career-ops<small>A–F scoring · streaming</small></span>';
